...
<div x-data="{ show: true }"
     ...
     style="<?php
         ...
         echo $flashStyleMap[$flash['type'] ?? ''] ?? 'background: rgba(0,212,255,0.15); color: #00d4ff; border: 1px solid rgba(0,212,255,0.3);';
     ?>">
    <?php $flashIkonMap = ['success' => '✅', 'error' => '❌', 'warning' => '⚠️']; ?>
    <span><?= $flashIkonMap[$flash['type'] ?? ''] ?? 'ℹ️' ?></span>
