        ...
        <div class="space-y-4">
            ...
            <div class="rounded-2xl p-5 text-center" style="background: rgba(15,23,62,0.6); border: 1px solid rgba(255,255,255,0.06);">
                ...
                <div class="flex gap-2 mt-4">
                    <a href="<?= APP_URL ?>/musteri-ekle.php?id=<?= $id ?>" class="flex-1 py-2 text-xs rounded-xl" style="background:rgba(0,212,255,0.1);color:#00d4ff;border:1px solid rgba(0,212,255,0.2);">Düzenle</a>
                    <a href="tel:<?= e($musteri['telefon']) ?>" class="flex-1 py-2 text-xs rounded-xl" style="background:rgba(0,255,136,0.1);color:#00ff88;border:1px solid rgba(0,255,136,0.2);">Ara</a>
                </div>
            </div>

            <!-- Tercihler -->
            <?php $tercihler = is_array($musteri['tercihler']) ? $musteri['tercihler'] : []; ?>
                ...
                <div class="divide-y" style="--tw-divide-opacity: 0.04;">
                    ...
                    <div class="flex items-center gap-3 px-4 py-3 hover:bg-white/2 transition-colors border-b" style="border-color:rgba(255,255,255,0.04);">
                        ...
                        <div class="flex-1 min-w-0">
                            <a href="<?= APP_URL ?>/ilan-detay.php?id=<?= (int)$es['ilan_id'] ?>" class="text-sm font-medium hover:text-cyan-400 truncate" style="color:#e8ecf4;"><?= e(truncate($es['baslik'],50)) ?></a>
                            <div class="text-xs mt-0.5" style="color:#7a8599;"><?= formatFiyat((float)$es['fiyat']) ?> · <?= zamanFarki($es['created_at']) ?></div>
                        </div>
